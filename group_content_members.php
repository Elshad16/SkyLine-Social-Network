		...
		<?php if (group_access($_SESSION['mybook_userid'], $group_data, 'member')): ?>
			...
			';
				...
				<br>
	 			...
	 			<input id="post_button" type="submit" value="Save" style="font-size:11px;margin-right:10px;background-color:#1b9186 ;width:auto;">
	 			<a href="' . ROOT . 'group/' . $group_data['userid'] . '/members">
					<input id="post_button" type="button" value="Cancel" style="font-size:11px;margin-right:10px;background-color:#91261b ;width:auto;">
				</a>
				</form>
				';
