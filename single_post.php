...
<head>
	<title>Single Post | SkyLine</title>
</head>
...
<body style="font-family: tahoma; background-color: #d0d8e4;">
	...
	<?php if (!($is_group_post && $group_data['group_type'] == 'private' && !group_access($_SESSION['mybook_userid'], $group_data, 'member'))): ?>
					...
					<div style="border:solid thin #aaa; padding: 10px;background-color: white;">
						...
						<?php else: ?>
							<a href="<?= ROOT ?>single_post/<?php echo $ROW['parent'] ?>">
								<input id="post_button" style="width:auto;float: left;cursor: pointer;" type="button"
									value="Back to main post" />
							</a>
						<?php endif; ?>
		...
		<!-- end post -->
	<?php else: ?>
		<div style="padding: 1em;text-align: center;background-color: white;">Sorry, you do not have access to this content!
		</div>
	<?php endif; ?>
</body>
